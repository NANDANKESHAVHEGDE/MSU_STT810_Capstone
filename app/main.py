...
pages = ["Overview", "Data Preparation", "EDA", "Price Analysis", "Recommendations"]
...
if selected_page == "Overview":
    ...
    with col3:
        st.markdown(
            """
            <div class='metric-box'>
                <div class='metric-title'>Evaluation Metrics</div>
                <div>Precision@K, MAP</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        ...
        - **Recommendation Model Development:** Implement collaborative filtering, hybrid models, and multivariate statistics.
        - **Feature Engineering:** Derive insights using temporal features, session behavior, and user preferences.
        - **Evaluation Metrics:** Measure performance using metrics like Precision@K and MAP.
...
# Data Preparation Page with Styling
    ...
    price_image = Image.open("../Images/Data_prep2.png")  # Replace with the correct path
    ...
    event_types_image = Image.open("../Images/Data_prep3.png")  # Replace with the correct path
    ...
    pmf_image = Image.open("../Images/Data_prep1.png")  # Replace with the correct path
